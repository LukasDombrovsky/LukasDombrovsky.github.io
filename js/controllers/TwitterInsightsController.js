app.controller('TwitterInsightsController', ['$scope','$location','$http','$timeout','$anchorScroll',
 function($scope,$location,$http,$timeout,$anchorScroll) {

    window.scrollTo(0, 0);

    // // Apending custom stylesheets 
    // angular.element(querySelector('head')).append('<link href=../../css/twitterInsights_style/magnific-popup.css" rel="stylesheet">');
    // angular.element(querySelector('head')).append('<link href="../../css/twitterInsights_style/creative.css" rel="stylesheet">');
    // angular.element(querySelector('head')).append('<link href="../../css/twitterInsights_style/percent.css" rel="stylesheet">');
    // angular.element(querySelector('head')).append('<link href="../../css/twitterInsights_style/sparkleProgressbar.css" rel="stylesheet">');
    // angular.element(querySelector('head')).append('<link href="../../css/twitterInsights_style/sentiment.css" rel="stylesheet">');
    // angular.element(querySelector('head')).append('<link href="../../css/twitterInsights_style/dropdown.css" rel="stylesheet">');
    ...
    $scope.startHashtagAnalysis = function(index) {
        ...
        angular.forEach(angular.element(document.querySelectorAll(".sparkleProgressbar")), function(value, key){
            ...
            // t.find('.sparkleBar').css('width', hashtag[emotion]+'%');
